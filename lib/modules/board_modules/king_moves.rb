module KingMoves
    ...
    #     moves = []
    #     moves << [x + 1, y] if (x + 1 < 8) && constraints_are_met?([x + 1, y], current_color) 
    #     moves << [x - 1, y] if (x - 1 >= 0) && constraints_are_met?([x - 1, y], current_color) 
    #     moves << [x, y + 1] if (y + 1 < 8) && constraints_are_met?([x, y + 1], current_color) 
    #     moves << [x, y - 1] if (y - 1 >= 0) && constraints_are_met?([x, y - 1], current_color)
    #     moves << [x + 1, y+ 1] if (x + 1 < 8 && y + 1 < 8) && constraints_are_met?([x + 1, y + 1], current_color) 
    #     moves << [x - 1, y + 1] if (x - 1 >= 0 && y + 1 < 8) && constraints_are_met?([x - 1, y + 1], current_color) 
    #     moves << [x + 1, y - 1] if (x + 1 < 8 && y - 1 >= 0) && constraints_are_met?([x + 1, y - 1], current_color) 
    #     moves << [x - 1, y - 1] if (x - 1 >= 0 && y - 1 >= 0) && constraints_are_met?([x - 1, y - 1], current_color) 
    #     moves
    # end
