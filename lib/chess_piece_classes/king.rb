...
class King < BasicChessPiece
    ...
    def get_moves
        ...
        adj_list = []
        adj_list << [x + 1, y] unless x + 1 > 7
        adj_list << [x - 1, y] unless x - 1 < 0
        adj_list << [x, y + 1] unless y + 1 > 7
        adj_list << [x, y - 1] unless y - 1 < 0
        adj_list << [x + 1, y + 1] unless x + 1 > 7 || y + 1 > 7
        adj_list << [x - 1, y + 1] unless x - 1 < 0 || y + 1 > 7
        adj_list << [x + 1, y - 1] unless x + 1 > 7 || y - 1 < 0
        adj_list << [x - 1, y - 1] unless x - 1 < 0 || y - 1 < 0
        adj_list
    end
